<script setup>
    ...
    const updateJob = async () => {
        try {
            const response = await axios.put(`/api/jobs/${id}`, state.job)
...
<template>
        ...
        >
          <form @submit.prevent="updateJob">
            ...
            <div class="mb-4">
              ...
              >
              <textarea
                v-model="state.job.company.description"
            ...
            <div class="mb-4">
              ...
              <input
                type="email"
                v-model="state.job.company.contactEmail"
                id="contact_email"
                name="contact_email"
                class="border rounded w-full py-2 px-3"
            ...
            <div class="mb-4">
              ...
              <input
                type="tel"
                v-model="state.job.company.contactPhone"
                id="contact_phone"
                name="contact_phone"
                class="border rounded w-full py-2 px-3"
    ...
    <section v-else="state.loading" class="flex justify-center py-6">
